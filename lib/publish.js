...
Meteor.publish('findMenuItems', function(menuName, currentLang) {
    ...
    // check permissions
    if (
        Skeletor.SkeleUtils.Permissions.checkPermissions(Skeletor.Utilities.getPermissions('Pages', 'read')) &&
        Skeletor.SkeleUtils.Permissions.checkPermissions(Skeletor.Utilities.getPermissions('Menus', 'read'))
